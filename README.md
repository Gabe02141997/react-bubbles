...
Tokens are used to authenticate a user, so that they can proceed to a private route.
- [ ] What steps can you take in your web apps to keep your data secure?
You can set up an authentication for the client-side server, so that a user must pass a token to access web page(s)
- [ ] Describe how web servers work.
Web servers are distinguished by their DNS name, and the location(URL), is displayed by the HTML language. Web server serves the Web page.
